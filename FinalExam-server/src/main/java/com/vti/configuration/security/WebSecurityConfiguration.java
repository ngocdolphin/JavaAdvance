    ...
    public SecurityFilterChain filterChain(HttpSecurity http, AuthExceptionHandler authExceptionHandler) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .antMatchers(HttpMethod.PUT, "/api/v1/accounts/**", "/api/v1/departments/**").hasAnyAuthority("ADMIN")
                        .antMatchers(HttpMethod.POST, "/api/v1/accounts/**", "/api/v1/departments/**").hasAnyAuthority("ADMIN")
